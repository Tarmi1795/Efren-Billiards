        ...
        <div className="grid grid-cols-2 lg:grid-cols-6 gap-8 lg:gap-12 mb-16">
          ...
          <div className="col-span-2 lg:col-span-2">
            ...
            <div className="flex gap-4">
              <a href="https://www.facebook.com/share/1DZ7ux6Qmi/?mibextid=wwXIfr" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-brand transition-colors"><Facebook size={20} /></a>
              <a href="https://www.instagram.com/efrenbilliards?igsh=YnQwdDI1MjJ0aDZm" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-brand transition-colors"><Instagram size={20} /></a>
              <a href="https://www.tiktok.com/@efren.billiards.m?_r=1&_t=ZS-93hdvwpNUdp" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-brand transition-colors">
          ...
          <div>
            ...
            <div className="mt-4">
              <a href="https://maps.app.goo.gl/NAggUvmWoE7Vh7cA6?g_st=ic" target="_blank" className="text-brand font-bold uppercase underline hover:text-white transition-colors">Get Directions</a>
            </div>
          </div>
        </div>
